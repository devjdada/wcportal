...
<div x-data="{ show: false, name: '{{ $name }}' }" x-on:open-modal.window="show = ($event.detail.name === name)"
    ...
    {{-- Gray Background --}}
    <div x-on:click="show = true" class="fixed inset-0 bg-gray-300 opacity-40"></div>
