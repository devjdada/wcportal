                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                ...
                                <th scope="col" class="p-4 text-xs font-medium text-lenc text-gray-500 uppercase dark:text-gray-400">
                                    Contact
                                </th>
                                <th scope="col" class="p-4 text-xs font-medium text-lenc text-gray-500 uppercase dark:text-gray-400">
                                    Date
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
                                        <input id="checkbox-{{ $nc->id}}" aria-describedby="checkbox-1" type="checkbox" class="w-4 h-4 border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:focus:ring-primary-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
                                        <label for="checkbox-{{ $nc->id }}" class="sr-only">checkbox</label>
                                    </div>
                                </td>
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                    <div class="text-base font-semibold text-gray-900 dark:text-white">{{ $nc->surname
                                        }} {{ $nc->firstname }}</div>
                                    <div class="text-sm font-normal text-gray-500 dark:text-gray-400">{{ $nc->phone}}
                                    </div>
                                </td>
        ...
        <form wire:submit="save">
            <div class="grid grid-cols-2 gap-4 mb-8">
                <div class="mt-1">
                    ...
                    <x-input wire:model="ncForm.surname" name="surname" class="block mt-1 w-full" type="text" />
                </div>
                <div class="mt-1">
                    <x-label for="title" value="{{ __('Lastname') }}" />
                    <x-input wire:model="ncForm.firstname" name="lastname" class="block mt-1 w-full" type="text" />
                </div>
                <div class="mt-1">
                    <x-label value="{{ __('Phone') }}" />
                    <x-input readonly wire:model="ncForm.phone" class="block mt-1 w-full" type="tel" />
                </div>
                <div class="mt-1">
                    <x-label value="{{ __('Email') }}" />
                    <x-input wire:model="ncForm.email" class="block mt-1 w-full" type="email" />
                </div>
                <div class="mt-1 col-span-2 ">
                    <x-label value="{{ __('Address') }}" />
                    <x-textarea wire:model="ncForm.address" name="address" class="block mt-1 w-full"></x-textarea>
                </div>
                <div class="mt-1">
                    <x-label value="{{ __('Gender') }}" />
                    <x-select wire:model="ncForm.gender" class="block mt-1 w-full">
                ...
                <div class="mt-1">
                    ...
                    <x-select wire:model="ncForm.marital" class="block mt-1 w-full">
                ...
                <div class="mt-1">
                    ...
                    <x-input type="date" wire:model="ncForm.born_again_on" class="block mt-1 w-full" />
                </div>

                <div class="mt-1 col-span-2 ">
                    <x-label value="{{ __('Address') }}" />
                    <x-textarea wire:model="ncForm.prayer_point" class="block mt-1 w-full"></x-textarea>
                </div>
                <didv class="mt-4">
                    ...
                    <x-button wire:click="closeNewNCDialog" type="button" class="dark:bg-red-600  hover:bg-red-800 dark:hover:bg-red-800">
                        Close
                    </x-button>
                </didv>
            </div>
        ...
        <form wire:submit="lookup">
            <div class="flex flex-col gap-4 mb-8">
                <div class="mt-4">
                    ...
                    <x-input wire:model="ncForm.phone" name="phone" class="block mt-1 w-full" type="tel" />
                </div>
