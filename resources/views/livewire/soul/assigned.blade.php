    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All Contact Reports</h1>
            </div>
                ...
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            ...
                            @foreach ($assigneds as $assiged)
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
                                        <input id="checkbox-{{ $assiged->id }}" aria-describedby="checkbox-1"
                                            type="checkbox"
                                            class="w-4 h-4 border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:focus:ring-primary-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
                                        <label for="checkbox-{{ $assiged->id }}" class="sr-only">checkbox</label>
                                    </div>
                                </td>
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                    <div class="text-base font-semibold text-gray-900 dark:text-white">
                                        {{ $assiged->contact->surname }} {{ $assiged->contact->firstname }}
                                    </div>
                                    <div class="text-sm font-normal text-gray-500 dark:text-gray-400">{{
                                        $assiged->contact->phone
                                        }}
                                    </div>
                                </td>
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                    <div class="text-base font-semibold text-gray-900 dark:text-white">
                                        {{ $assiged->assign_to->name }}
                                    </div>
                                    <div class="text-sm font-normal text-gray-500 dark:text-gray-400">{{
                                        $assiged->assign_to->phone
                                        }}
                                    </div>
                                </td>
                                <td
