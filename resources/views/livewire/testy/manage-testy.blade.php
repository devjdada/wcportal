<div>
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All Testimony</h1>
            </div>
            <div class="sm:flex">
    ...
    <div class="grid grid-cols-3 gap-6 mt-4 ml-2 dark:text-white">
        @foreach ($testimonies as $tsy)
            <div class="bg-white rounded-lg shadow-md dark:bg-gray-800">
                <div class="flex items-center ">
                    <div class="">
                        <img class="" src="{{ $tsy->image }}" alt="{{ $tsy->title }}">
                        <div class="mt-4 text-center">
                            <h1 class="text-4xl font-bold dark:text-white">{{ $tsy->title }}</h1>
                        </div>
                        <div class="flex justify-between p-6">
                            <div class="">
                                <button wire:click='openAddMoreImageModal({{ $tsy->id }})'
                                ...
                                <button wire:click='deleteGallery({{ $tsy->id }})'
                                ...
                                <button wire:click='openGalleryModal({{ $tsy->id }})'
    ...
    <x-dialog wire:model="showCreateModal" :title="'New Testimony'" :maxWidth="'md'">
            ...
            <form wire:submit="save">
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6">
                        <label for="testimony" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Testimony</label>
                        <x-textarea id="testimony" wire:model="testimony" rows="8">
                        </x-textarea>
                    </div>
                    <div class="col-span-6">
                    ...
                    <div class="col-span-3">
                        <label for="name" class="mb-2 mr-4 text-sm font-medium text-gray-900 dark:text-white">Born
                            Name</label>
                        <x-input id="name" type='text' wire:model="name" />
                    </div>
                    <div class="col-span-3">
                        <label for="email" class="mb-2 mr-4 text-sm font-medium text-gray-900 dark:text-white">Born
                            Email</label>
                        <x-input id="email" type='email' wire:model="email" />
                    </div>
                    <div class="col-span-3">
                        <label for="phone" class="mb-2 mr-4 text-sm font-medium text-gray-900 dark:text-white">Born
                            Phone Number</label>
