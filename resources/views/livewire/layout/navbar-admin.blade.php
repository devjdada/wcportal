        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="#" class="flex ml-2 md:mr-24">
                    <img src="{{ asset('static/icons/winners_logo.png') }}" class="h-12 mr-2"
                        alt="Winners Chapel Logo" />
                    <span
                        class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">WinnersChapel</span>
                </a>
            ...
            <div class="flex items-center">
                ...
                <div class="flex items-center ml-3">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="flex text-sm transition border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 dark:text-white">
