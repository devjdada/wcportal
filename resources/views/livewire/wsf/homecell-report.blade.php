<div>
    ...
    <div
        ...
        <div class="w-full mb-1">
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All {{ $hrForm->week }}</h1>
            </div>
                ...
                <div class="flex items-center mb-4 sm:mb-0">
                    <form class="sm:pr-3">
                        ...
                        <div class="relative w-48 mt-1 sm:w-64 xl:w-96">
                            <x-input type="date" wire:model.live="hrForm.week" />
                        </div>
                    </form>
                ...
                <div class="overflow-hidden shadow">
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            @foreach ($homecellReports as $hr)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <td class="w-4 p-4">
                                        <div class="flex items-center">
                                            <input id="checkbox-{{ $hr->id }}" aria-describedby="checkbox-1"
                                                type="checkbox"
                                                class="w-4 h-4 border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-300 dark:focus:ring-primary-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
                                    ...
                                    <td
                                        ...
                                        <div class="text-base font-semibold text-gray-900 dark:text-white">
                                            {{ $hr->homecells->title }} {{ $hr->homecells->id }}
                                        </div>
                                        <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                            {{ $hr->homecells->address }}</div>
                                    </td>
                                    <td
    ...
    <x-dialog wire:model="delReportModal">
    ...
    <x-dialog wire:model="newReportModal" :maxWidth="'sm'">
        <x-slot name="title">
            @if ($editMode)
                Edit
            @else
