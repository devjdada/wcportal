        ...
        <div class="w-full mb-1">
            ...
            <div class="sm:flex">
                ...
                <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                    <button wire:click='openNewBlogModal'
        ...
        @foreach ($blogs as $blog)
            <div class="bg-white rounded-lg shadow-md dark:bg-gray-800">
                <div class="flex items-center ">
                    <div class="">
                        <img class="" src="{{ $blog->image }}" alt="{{ $blog->title }}">

                        <div class="flex justify-between p-6">
                            <div class="">
                                <button wire:click='openAddMoreImageModal({{ $blog->id }})'
                                ...
                                <button wire:click='deleteGallery({{ $blog->id }})'
                                ...
                                <button wire:click='openGalleryModal({{ $blog->id }})'
                ...
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6">
                        <label for="content" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Content</label>
                        <x-textarea id="content" wire:model="content" rows="10">
                        </x-textarea>
                    </div>
                    <div class="col-span-6">
                    ...
                    <div class="col-span-3">
                        <label for="image" class="mb-2 mr-4 text-sm font-medium text-gray-900 dark:text-white">
                            Image</label>
                        <x-input id="image" type='file' wire:model="image" />
                    </div>
                    <div class="col-span-3">
                        <label for="dated" class="mb-2 mr-4 text-sm font-medium text-gray-900 dark:text-white">
                            Dated</label>
                        <x-input id="dated" type='date' wire:model="dated" />
                    </div>
                </div>
